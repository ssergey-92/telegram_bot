...
def low_price_command(message: Message) -> None:
    ...
    command "low_price" and calling function(reply_msg_low_price()) for
    handling command.
...
def reply_msg_low_price(chat_id: int, user_id: int) -> None:
    ...
    HandleSearchMsg.initialize_command(chat_id, user_id, low_price_shortcut,
                                       "PRICE_LOW_TO_HIGH",
                                       1, 1000000,
...
def budget_input_city_state(message: Message) -> None:
    """
    Catching state: BudgetSearchStates.input_city and calling
...
def budget_confirm_city_state_callback(call: CallbackQuery):
    """
    Catching state: BudgetSearchStates.confirm_city with callback query from
...
def budget_confirm_city_state_msg(message: Message) -> None:
    """
    Catching state: BudgetSearchStates.confirm_city and calling
    HandleSearchMsg.confirm_city() for handling it.
...
def budget_check_in_date_state_cb(call: CallbackQuery) -> None:
    """
     Catching state: BudgetSearchStates.check_in_date with callback query from
...
def budget_check_in_date_state_msg(message: Message) -> None:
    """
    Catching state: BudgetSearchStates.check_in_date and calling
...
def budget_check_out_date_state_cb(call: CallbackQuery) -> None:
    """
    Catching state: BudgetSearchStates.check_out_date with callback query
...
def budget_check_out_date_state_msg(message: Message) -> None:
    """
    Catching state: BudgetSearchStates.check_out_date and calling
...
def budget_travellers_state(message: Message) -> None:
    """
    Catching state: BudgetSearchStates.travellers and calling
...
def budget_hotel_amount_state(message: Message) -> None:
    """
    Catching state: BudgetSearchStates.hotels_amount and calling
...
def budget_photo_state(message: Message) -> None:
    """
    Catching state: BudgetSearchStates.hotels_photo and calling
...
def budget_photo_amount_state(message: Message) -> None:
    """
    Catching state: BudgetSearchStates.hotels_photo_amount and calling
